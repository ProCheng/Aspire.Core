...
using Aspire.Core.Common.LogHelper;
...
namespace Aspire.Core.AOP
{
    /// <summary>
    /// 拦截器AspireLogAOP 继承IInterceptor接口
    /// </summary>
    public class AspireLogAOP : IInterceptor
    {
        private readonly IHubContext<ChatHub> _hubContext;
        private readonly IHttpContextAccessor _accessor;

        public AspireLogAOP(IHubContext<ChatHub> hubContext, IHttpContextAccessor accessor)
        {
