...
{
    /// <summary>
    /// 事务拦截器AspireTranAOP 继承IInterceptor接口
    /// </summary>
    public class AspireTranAOP : IInterceptor
    {
        private readonly ILogger<AspireTranAOP> _logger;
        private readonly IUnitOfWorkManage _unitOfWorkManage;

        public AspireTranAOP(IUnitOfWorkManage unitOfWorkManage, ILogger<AspireTranAOP> logger)
        {
