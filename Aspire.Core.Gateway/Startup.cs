using Aspire.Core.AuthHelper;
using Aspire.Core.Common;
using Aspire.Core.Common.Caches;
using Aspire.Core.Extensions;
using Aspire.Core.Gateway.Extensions;
using Microsoft.AspNetCore.Authentication;
using System.Reflection;

namespace Aspire.Core.AdminMvc
{
    public class Startup
    {
        ...
        */
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCustomSwaggerMildd(() => Assembly.GetExecutingAssembly().GetManifestResourceStream("Aspire.Core.Gateway.index.html"));
