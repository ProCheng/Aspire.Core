...
using Aspire.Core.Common.Core;
using Aspire.Core.Common.Helper;
using Aspire.Core.Extensions;
using Aspire.Core.Extensions.Apollo;
using Aspire.Core.Extensions.Middlewares;
using Aspire.Core.Extensions.ServiceExtensions;
using Aspire.Core.Filter;
using Aspire.Core.Hubs;
using Aspire.Core.Serilog.Utility;
using Autofac;
...
app.UseSwaggerMiddle(() => Assembly.GetExecutingAssembly().GetManifestResourceStream("Aspire.Core.index.html"));
